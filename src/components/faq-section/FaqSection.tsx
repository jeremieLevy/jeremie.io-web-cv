...
const faqQuestions: Question[] = [
  {
    id: 1,
    quest:
      'Qu’elles sont les principales technologies maitrisées par jeremie.io ? ',
    answer: 'VueJS, Typescript, React, NestJS',
  },
  {
    id: 2,
    quest: 'Est ce que jeremie.io s’intègre facilement dans une équipe tech ?',
    answer:
      "Bien sur ! Il est d'ailleurs possible de consulter les recommandations de ses anciens collègues sur Linkedin",
  },
  {
    id: 3,
    quest: 'Est ce que jeremie.io peut générer des blagues ?',
    answer:
